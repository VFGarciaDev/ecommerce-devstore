...
export const ProductCard = ({slug, image, name, value, mainCard}:ProductCardProps) => {

    return (
        <Link href={`/product/${slug}`} className={cn("group relative bg-zinc-900 overflow-hidden", mainCard && "row-span-2")}>
